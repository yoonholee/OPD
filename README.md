...
Local fork note: vendored LlamaFactory was removed. SFT-style distillation is being migrated to native verl SFT recipes.
...
After the rollout finishes, use the generated teacher responses for student SFT. In this fork, use native verl SFT instead of LlamaFactory.
